    ...
    while True:
        ...
        if len(dets)>0:
            ...
            if Tracking:
                ...
                () = camera.convert2d_3d((face_tracking.left()+face_tracking.right())/2, (face_tracking.top()+face_tracking.bottom())/2)
                ...
                if yaw > 0.3:
                    ...
                    #TODO: add motion for looking at right and return back

                elif yaw < -0.3:
                    print ('You are looking at left.')
                    #TODO: add motion for looking at left and return back
